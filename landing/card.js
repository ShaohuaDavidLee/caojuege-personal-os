...
(function (global) {
  ...
  function css() {
    return [
      ...
      '.main{flex:1 1 auto;display:flex;flex-direction:column;justify-content:center;min-height:0;padding-bottom:150px}',
      '.headline{margin:0 80px;position:relative;z-index:1}',
      'h1{font-size:104px;font-weight:700;line-height:1;letter-spacing:.02em}',
      '.quote{font-size:26px;color:#47494b;font-style:italic;margin-top:22px}',
      '.quote::before{content:"\\300c"}.quote::after{content:"\\300d"}',
      '.underline{width:96px;height:2px;background:#47494b;margin-top:14px}',
      '.body-text{padding:44px 80px 0;font-size:28px;line-height:1.85;max-width:880px;letter-spacing:.03em}',
      '.body-text p{margin-bottom:18px}.body-text p:last-child{margin-bottom:0}',
      '.dark-block{margin:44px 80px 0;padding:28px 34px;background:#47494b;color:#e5e5e5;position:relative}',
      '.dark-block .label{font-size:15px;letter-spacing:.22em;color:rgba(229,229,229,.6);margin-bottom:14px}',
      '.dark-block .lines{font-size:22px;line-height:1.6}',
      ...
      '.footer{position:absolute;bottom:56px;left:80px;right:80px;display:flex;justify-content:space-between;align-items:flex-end;z-index:1}',
      '.url{font-size:18px;color:#1a1a1a}',
      '.sub{font-size:13px;color:#5c5e60;margin-top:6px;letter-spacing:.08em;font-family:-apple-system,sans-serif}',
      '.qr{width:104px;height:104px;background:#fff;padding:4px}',
  ...
  function cardMarkup(d, editable) {
    ...
    return [
      '<div class="card">',
      '<div class="watermark"><span>列</span><span>传</span></div>',
